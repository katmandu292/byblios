 ...
 */
    ...
    private CollectionEntity theCollection;
...
//			EditorEntity theEditor) {
			EditorEntity theEditor, CollectionEntity theCollection) {
	...
	public CollectionEntity getTheCollection() {
		return theCollection;
	}

	public void setTheCollection(CollectionEntity theCollection) {
		this.theCollection = theCollection;
	}
